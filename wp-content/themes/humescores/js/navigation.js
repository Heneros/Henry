...
(function( $ ) {
	...
	function initMainNavigation( container ) {
		...
		var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false })
			.append( humescroresScreenReaderText.icon )
			.append( $( '<span />', { 'class': 'screen-reader-text', text: humescroresScreenReaderText.expand }) );
		...
		container.find( '.current-menu-ancestor > button' )
			...
			.text( humescroresScreenReaderText.collapse );
		...
		container.find( '.dropdown-toggle' ).click( function( e ) {
			...
			screenReaderSpan.text( screenReaderSpan.text() === humescroresScreenReaderText.expand ? humescroresScreenReaderText.collapse : humescroresScreenReaderText.expand );
		});
	}
